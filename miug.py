...
start_button = ttk.Button(root,text='Start',fg='red',font=('Courier','16'),command=start_camera,height=1,width=9)
start_button.place(x=700,y=740)
...
def show_all_one_ball_widgets():
    ball_2_config_dropdown.place(x=300,y=130)
    ball_2_config_dropdown_label.place(x=250,y=130)
    ball_1_config_dropdown.place(x=180,y=130)
    ball_1_config_dropdown_label.place(x=130,y=130)
    ball_0_config_dropdown.place(x=60,y=130)
    ball_0_config_dropdown_label.place(x=10,y=130)
    current_ball_config_label.place(x=500,y=100)
    selected_config_midi_channel_dropdown.place(x=780,y=150)
    selected_config_midi_channel_dropdown_label.place(x=680,y=150)
    ...
    all_peaks_button.place(x=750,y=260)
    all_throws_button.place(x=750,y=310)
    all_catches_button.place(x=750,y=360)
...
def hide_all_one_ball_widgets():
    ball_2_config_dropdown.place(x=11770,y=150)
    ball_2_config_dropdown_label.place(x=11730,y=150)
    ball_1_config_dropdown.place(x=11670,y=150)
    ball_1_config_dropdown_label.place(x=11630,y=150)
    ball_0_config_dropdown.place(x=11570,y=150)
    ball_0_config_dropdown_label.place(x=11530,y=150)
    current_ball_config_label.place(x=1500,y=1130)
    selected_config_midi_channel_dropdown.place(x=11280,y=150)
    selected_config_midi_channel_dropdown_label.place(x=11180,y=150)
    ...
    all_peaks_button.place(x=11750,y=260)
    all_throws_button.place(x=11750,y=310)
    all_catches_button.place(x=11750,y=360)
    all_peaks_button.place(x=1750,y=260)
    all_throws_button.place(x=1750,y=310)
    all_catches_button.place(x=1750,y=360)
...
bottom_separator.place(x=0, y=720, relwidth=1)
...
Label(root, text='note').place(x=10,y=760)
midi_note_to_send_dropdown.place(x=50,y=750)

midi_channel_to_send_dropdown = OptionMenu(root, selected_midi_channel_to_send, *midi_channel_choices)
Label(root, text='channel').place(x=120,y=760)
midi_channel_to_send_dropdown.place(x=180,y=750)

midi_type_to_send_dropdown = OptionMenu(root, selected_midi_type_to_send, *midi_type_choices)
Label(root, text='type').place(x=250,y=760)
midi_type_to_send_dropdown.place(x=290,y=750)

send_midi_message_button = ttk.Button(root,text='Send midi message',fg='purple',command=send_midi_message,height=1,width=18)
send_midi_message_button.place(x=400,y=750)

####### BEGIN stuff shown if selected_number_of_balls.get() == 1: #######
ball_2_config_dropdown = OptionMenu(root, ball_2_selected_config, *ball_config_choices)
ball_2_config_dropdown.place(x=500,y=130)
ball_2_config_dropdown_label = Label(root, text='ball 2')
ball_2_config_dropdown_label.place(x=450,y=130)

ball_1_config_dropdown = OptionMenu(root, ball_1_selected_config, *ball_config_choices)
ball_1_config_dropdown.place(x=380,y=130)
ball_1_config_dropdown_label = Label(root, text='ball 1')
ball_1_config_dropdown_label.place(x=330,y=130)

ball_0_config_dropdown = OptionMenu(root, ball_0_selected_config, *ball_config_choices)
ball_0_config_dropdown.place(x=260,y=130)
ball_0_config_dropdown_label = Label(root, text='ball 0')
ball_0_config_dropdown_label.place(x=210,y=130)
...
point_single_line_input = ttk.Entry(root, width = 57)
point_single_line_input.place(x=400,y=450)
...
selected_config_midi_channel_dropdown.place(x=780,y=150)
selected_config_midi_channel_dropdown_label = Label(root, text='midi channel')
selected_config_midi_channel_dropdown_label.place(x=680,y=150)
...
def all_peaks_clicked():
    ...
    all_buttons = [left_cross_peak_button_selected[current_ball_config_index],left_column_peak_button_selected[current_ball_config_index],mid_column_peak_button_selected[current_ball_config_index],mid_cross_peak_button_selected[current_ball_config_index],right_column_peak_button_selected[current_ball_config_index],right_cross_peak_button_selected[current_ball_config_index]]
    if not all(all_buttons):
        left_column_peak_button_selected[current_ball_config_index] = left_cross_peak_button_selected[current_ball_config_index] = mid_column_peak_button_selected[current_ball_config_index] = mid_cross_peak_button_selected[current_ball_config_index] = right_column_peak_button_selected[current_ball_config_index] = right_cross_peak_button_selected[current_ball_config_index] = False
...
def all_throws_clicked():
    ...
    all_buttons = [left_cross_throw_button_selected[current_ball_config_index],left_column_throw_button_selected[current_ball_config_index],mid_column_throw_button_selected[current_ball_config_index],mid_cross_throw_button_selected[current_ball_config_index],right_column_throw_button_selected[current_ball_config_index],right_cross_throw_button_selected[current_ball_config_index]]
    if not all(all_buttons):
        left_cross_throw_button_selected[current_ball_config_index] = left_column_throw_button_selected[current_ball_config_index] = mid_column_throw_button_selected[current_ball_config_index] = mid_cross_throw_button_selected[current_ball_config_index] = right_column_throw_button_selected[current_ball_config_index] = right_cross_throw_button_selected[current_ball_config_index] = False
...
def all_catches_clicked():
    ...
    all_buttons = [left_cross_catch_button_selected[current_ball_config_index],left_column_catch_button_selected[current_ball_config_index],mid_column_catch_button_selected[current_ball_config_index],mid_cross_catch_button_selected[current_ball_config_index],right_column_catch_button_selected[current_ball_config_index],right_cross_catch_button_selected[current_ball_config_index]]
    if not all(all_buttons):
        left_cross_catch_button_selected[current_ball_config_index] = left_column_catch_button_selected[current_ball_config_index] = mid_column_catch_button_selected[current_ball_config_index] = mid_cross_catch_button_selected[current_ball_config_index] = right_column_catch_button_selected[selected_config] = right_cross_catch_button_selected[selected_config] = False
...
del midiout
#TODO
#tell user in color calibration that Q will leave calibration mode and get rid of the ability to enter calibration via A
#make it so when a point button is clicked, it cycles to the next one that has anything set, once it gets to the last
#   one that has something set in it, it shows 1 empty one and then goes back to the first one with something set in it
#when any of the point specifics are changed, save them to variables that are arrays with an index of the 
#   current point index, this is going to be very similar to how we do it about with the ball configs, XYZ 
#   
...
#   instead of a dropdown for note, we should have a dropdown that is full of every possible input based on
